...
<body>
	<form action='<spring:url value="/web/submitDataDeposit" > </spring:url>' method="post" modelAttribute="deposit" commandName="deposit">
   		<form:form method="GET" modelAttribute="deposit">
            ...
            <ul>
                ...
                <label path="depositAddConditions:">Deposit Add Conditions :</label></br>
                    <textarea id="depositAddConditions" name="depositAddConditions" rows="10" cols="70" ><c:out value="${deposit.depositAddConditions}"/></textarea>
                        <span class="error">
