...
public class BankDepositSoapServer extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req,
        ...
        /**
         * TODO load depositWSDl.xml file
         */
    ...
    public void doPost(HttpServletRequest req,
         ...
         *
         */
        if(request.getHeader("SOAPAction").equalsIgnoreCase("getBankDeposits")){
            try{
         ...
         *
         */
        if(request.getHeader("SOAPAction").equalsIgnoreCase("addBankDeposit")){
            try {
                messageFactory = MessageFactory.newInstance();
         ...
         *
         */
        if(request.getHeader("SOAPAction").equalsIgnoreCase("getBankDepositById")){
            try {
                messageFactory = MessageFactory.newInstance();
                MimeHeaders header = new MimeHeaders();
                //header.setHeader("Content-Type", "text/xml");
         ...
         * @parameter /SOAP message <depositName>{Name}</depositName>
         *
         */
        if(request.getHeader("SOAPAction").equalsIgnoreCase("getBankDepositByName")){
            try {
                messageFactory = MessageFactory.newInstance();
                MimeHeaders header = new MimeHeaders();
         ...
         *
         */
        if(request.getHeader("SOAPAction").equalsIgnoreCase("updateBankDeposit")){
            try {
                messageFactory = MessageFactory.newInstance();
         ...
         *
         */
        if(request.getHeader("SOAPAction").equalsIgnoreCase("getBankDepositors")){
            try{
                messageFactory = MessageFactory.newInstance();
                outGoingMessage = messageFactory.createMessage();
         ...
         *
         */
        if(request.getHeader("SOAPAction").equalsIgnoreCase("addBankDepositor")){
            try {
                messageFactory = MessageFactory.newInstance();
                MimeHeaders header = new MimeHeaders();
         ...
         *
         */
        if(request.getHeader("SOAPAction").equalsIgnoreCase("getBankDepositorById")){
            try {
                messageFactory = MessageFactory.newInstance();
                MimeHeaders header = new MimeHeaders();
         ...
         * @parameter /SOAP message <depositorName>{Name}</depositorName>
         *
         */
        if(request.getHeader("SOAPAction").equalsIgnoreCase("getBankDepositorByName")){
            try {
                messageFactory = MessageFactory.newInstance();
                MimeHeaders header = new MimeHeaders();
         ...
         *
         */
        if(request.getHeader("SOAPAction").equalsIgnoreCase("updateBankDepositor")){
            try {
                messageFactory = MessageFactory.newInstance();
         ...
         *
         */
        if(request.getHeader("SOAPAction").equalsIgnoreCase("removeBankDepositor")){
            try {
                messageFactory = MessageFactory.newInstance();
                MimeHeaders header = new MimeHeaders();
         ...
         *
         */
        if(request.getHeader("SOAPAction").equalsIgnoreCase("deleteBankDeposit")){
            try {
                messageFactory = MessageFactory.newInstance();
                MimeHeaders header = new MimeHeaders();
